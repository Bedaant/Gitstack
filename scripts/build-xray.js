...
// ---------------------------------------------------------------------------
// 2b. GITHUB API PROXY — Route X-Ray through backend so it uses GITHUB_TOKEN
// ---------------------------------------------------------------------------
html = html.replace(
  "var url='https://api.github.com/'+path;",
  "var url='/api/github-proxy/'+path;"
);
...
const CANONICAL_LINK = '<link rel="canonical" href="https://gitstack.pro/repo-xray" /><link rel="alternate" hreflang="en" href="https://gitstack.pro/repo-xray" /><link rel="alternate" hreflang="x-default" href="https://gitstack.pro/repo-xray" />';
