      ...
      <main className="py-12 px-4 flex-1">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-pastel-lavender border-4 border-black neo-shadow-lg mb-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {stacks.map(stack => (
                <a
                  ...
                  className="neo-card p-6 bg-white block hover:border-primary transition-colors"
                ...
                >
                  ...
                  <p className="text-sm text-zinc-500 mb-4">{stack.description}</p>
